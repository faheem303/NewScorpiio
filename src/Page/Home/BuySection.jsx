            ...
            <div className="pt-[31px] w-full block xs:space-y-3 sm:space-y-3 md:space-y-3 items-end justify-between 2xl:flex xl:flex lg:flex md:flex sm:flex flex 2xl:flex-row xl:flex-row lg:flex-row md:flex-col sm:flex-col flex-col">
                <div className="2xl:w-[28%] xl:w-[30%] lg:w-[38%] md:w-[100%] sm:w-full w-full  space-y-3 pb-7">
                    <div className="stepsbg py-4 2xl:space-y-1 px-8 rounded-[40px]">
                        ...
                        <h4 className="2xl:text-[21px] text-[16px] gradientText xs:text-[16px] font-[900] font-[Inter] text-white text-white leading-[29px] ">Connect your Wallet</h4>
                    ...
                    <div className="stepsbg py-4 2xl:space-y-1 px-8 rounded-[40px]">
                        ...
                        <h4 className="2xl:text-[21px] text-[16px] gradientText xs:text-[16px] font-[900] font-[Inter] text-white text-white leading-[29px] ">Confirm Transaction</h4>
                    ...
                    <div className="stepsbg py-4 2xl:space-y-1 px-8 rounded-[40px]">
                        ...
                        <h4 className="2xl:text-[21px] text-[16px] gradientText xs:text-[16px] font-[900] font-[Inter] text-white text-white leading-[29px] ">Claim Tokens</h4>
