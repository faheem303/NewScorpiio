  ...
  return (
    ...
    <div className="2xl:w-[85%] xl:w-[85%] lg:w-[85%] md:w-[90%] sm:w-[90%] w-[90%]  mx-auto pb-[95px]">
        <div className="flex flex-wrap items-center 2xl:justify-between xl:justify-between lg:justify-between md:justify-center sm:justify-center justify-center gap-y-[20px]">
          <div className="2xl:w-[49%] xl:w-[49%] lg:w-[49%] md:w-[90%] sm:w-[95%] w-[100%] flex flex-col 2xl:gap-[20px] xl:gap-[20px] lg:gap-[20px] md:gap-[20px] sm:gap-[17px] gap-[17px]">
          ...
          <div className="2xl:w-[49%] xl:w-[49%] lg:w-[49%] md:w-[90%] sm:w-[95%] w-[100%]">
            <img className="w-[100%] 2xl:h-[497px] xl:h-[497px] lg:h-[497px] md:h-[497px] sm:h-auto h-auto" src={CarImg} alt="" />
          </div>
        </div>
      </div>
    </>
