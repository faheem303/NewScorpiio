    ...
    return (
        <div className="" >
            <div className="">
               ...
               <div className="exchnagecolor px-[50px] h-[244px]  flex items-center justify-center rounded-[20px]">
                    <img className="h-[75px]" src={bit} alt="" />
                </div>
                <div className="exchnagecolor px-[130px] h-[244px]  flex items-center justify-center rounded-[20px]">
