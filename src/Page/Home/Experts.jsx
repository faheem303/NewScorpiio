  ...
  return (
    <>
      <div className="2xl:w-[85%] xl:w-[85%] lg:w-[85%] md:w-[90%] sm:w-[90%] w-[90%]  mx-auto pb-[95px]">
        ...
        <div className="2xl:pb-[83px] xl:pb-[83px] lg:pb-[83px] md:pb-[44px] sm:pb-[44px] pb-[44px]">
          <CryptoExperts container={"flex flex-row-reverse flex-wrap-reverse 2xl:justify-between xl:justify-between lg:justify-between md:justify-center sm:justify-center justify-center gap-y-[23px]"} title={"I really like this project, and they have a big shot of becoming a huge success"} para={"The UI (Design) of the Casino is very nice, and they have a ton of different Partnerships that will make this casino truly exceptional."} smallContainer={"flex-row-reverse justify-end"} btnLarge={"Crypto Panda"} followerslarge={"Youtuber | 15k Followers"} srcLarge={Panda} srcSmall={SmallPanda} name={"Crypto Panda"} btnFollowers={"Youtuber | 15k Followers"} lastSrc={""}/>
        </div>
      </div>
    </>
  );
