        ...
        <div className="py-[70px]" >
            <div className="">
                ...
                <div className="2xl:hidden xl:hidden lg:hidden md:block sm:block block  space-y-5">
                    ...
                    <p className="xs:text-center text-[20px] opacity-70 pb-2 text-white">Since 2017 the crypto casino market has grown rapidly and latest figures show the crypto casino market is now valued at $250 Million. This represents just under 0.1% of the total Casino
