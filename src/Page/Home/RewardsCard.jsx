...
const RewardCard = ({ item, amountRange, handleRange }) => {
    ...
    return (
       ...
       <div className="rounded-md  bgposter py-4">
         <div className=" flex justify-between  px-5 xs:px-3   w-[100%] sm:w-[100%] xs:w-[100%] ">
            {
                <>
                    <div className="space-y-4 w-[56%] md:w-[100%] sm:w-full xs:w-full pr-2">
                        <div className="flex items-center">
                          
                            <h3 className="text-[24px] text-white sm:text-[18px] xs:text-[16px] font-[600] font-Poppins pt-2 ">{item.packageType}</h3>
                        </div>
