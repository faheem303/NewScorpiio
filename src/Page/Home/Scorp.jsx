...
function Scorp() {
  return (
    ...
    <div className="flex flex-wrap 2xl:justify-between xl:justify-between lg:justify-between md:justify-center sm:justify-center justify-center gap-y-[19px] 2xl:border-[1.5px] xl:border-[1.5px] lg:border-[1.5px] md:border-[1.5px] sm:border-[1.5px] border-[0] border-solid border-[#FFFBC8] 2xl:py-[40px] xl:py-[40px] lg:py-[40px] md:py-[40px] sm:py-[40px] py-0 2xl:px-[43px] xl:px-[43px] lg:px-[43px] md:px-[43px] sm:px-[43px] px-0 rounded-[37px]">
      <div className="2xl:w-[49%] xl:w-[49%] lg:w-[45%] md:w-[90%] sm:w-[95%] w-[90%] flex flex-col 2xl:gap-[25px] xl:gap-[25px] lg:gap-[25px] md:gap-[25px] sm:gap-[17px] gap-[17px]">
       <div className='flex flex-col 2xl:gap-y-[3px] xl:gap-y-[3px] lg:gap-y-[3px] md:gap-y-[3px] sm:gap-y-[17px] gap-y-[17px]'>
       ...
       <div className='flex flex-col 2xl:gap-y-[6px] xl:gap-y-[6px] lg:gap-y-[6px] md:gap-y-[6px] sm:gap-y-[17px] gap-y-[17px] 2xl:items-start xl:items-start lg:items-start md:items-center sm:items-center items-center'>
        ...
        <Button btnText={"BUY $SCORP NOW"} className={"btn 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px] text-[18px] text-[black] 2xl:font-[600] xl:font-[600] lg:font-[600] md:font-[600] sm:font-[600] font-[500] 2xl:leading-[24px] xl:leading-[24px] lg:leading-[24px] md:leading-[24px] sm:leading-[24px] leading-[21px] 2xl:h-[48px] xl:h-[48px] lg:h-[48px] md:h-[48px] sm:h-[48px] h-[42px] rounded-[37px] 2xl:w-[225px] xl:w-[225px] lg:w-[225px] md:w-[225px] sm:w-[225px] w-[100%]"}/>
        </div>
      </div>
      <div className="2xl:w-[49%] xl:w-[49%] lg:w-[54%] md:w-[90%] sm:w-[95%] w-[100%]">
        <img
          className="w-[100%] 2xl:h-[424px] xl:h-[424px] lg:h-[424px] md:h-[424px] sm:h-auto h-auto"
          src={ScorpImg}
          alt=""
        />
      </div>
